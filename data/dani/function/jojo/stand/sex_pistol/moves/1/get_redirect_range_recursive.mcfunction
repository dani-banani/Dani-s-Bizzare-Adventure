...
execute if score #range dani.Global matches 0 run summon marker ~ ~ ~ {Tags:["LOOKATME"]}
execute if score #range dani.Global matches 1.. positioned ^ ^ ^.25 run function dani:jojo/stand/sex_pistol/moves/1/get_redirect_range_recursive
